...
Legends Ultimate Captions is designed to be installed as a repo plus an agent
...
```text
Use Legends Ultimate Captions to inspect this video, build accurate active-word
...
```text
Use the legends-ultimate-captions skill. Start with the doctor command, then
...
```text
Use the Legends Ultimate Captions extension to review caption text, identify
