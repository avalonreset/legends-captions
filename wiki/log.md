...
- Captured upper editorial-caption policy: short static-yellow topic markers, no default per-word highlight, no duplicate transcript lane, and no outgoing/incoming overlap.
- Updated timing, render QA, and checklist pages with the final-tail rule: Shorts should end about three frames after the final spoken word unless a deliberate hold is documented.
...
- Added initial Codex Obsidian brain structure.
